    ...
    *,
    ...
    if profile == ExecutionProfile.LOCAL_ONLY:
        obs_events.emit_event(
            ...
            component="llm",
            event="llm.disabled",
            summary="LLM disabled for LOCAL_ONLY journal formalization",
        ...
        obs_events.emit_event(
            ...
            component="llm",
            event="llm.fallback",
            summary="Using deterministic fallback journal formalization",
            correlation_id=correlation_id,
            session_id=session_id,
            run_id=run_id,
            trace_id=correlation_id,
    ...
    if not _enabled_remote_llm():
        obs_events.emit_event(
            ...
            component="llm",
            event="llm.disabled",
            summary="Remote LLM disabled for journal formalization",
            correlation_id=correlation_id,
            session_id=session_id,
            run_id=run_id,
            trace_id=correlation_id,
